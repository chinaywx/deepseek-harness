...
export const zh = {
  ...
  'details.panels': '面板',
  'details.noPanels': '暂无可用面板',
  'details.close': '关闭面板',
  'details.open': '打开面板',
  'details.refresh': '刷新',
  'details.fullscreen': '全屏',
  'details.exitFullscreen': '退出全屏',
  'todo.title': '任务',
...
export const en = {
  ...
  'details.noPanels': 'No panels available',
  'details.close': 'Close panel',
  'details.open': 'Open panel',
  'details.refresh': 'Refresh',
  'details.fullscreen': 'Fullscreen',
  'details.exitFullscreen': 'Exit fullscreen',
  'todo.title': 'To-dos',
