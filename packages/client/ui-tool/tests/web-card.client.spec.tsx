...
// resultView, and the chat render sites that consume it —the keyed
// WebRow (registered under both web_search and web_fetch) and the GenericToolCard
// render-site fallback. Mirrors
// terminal-card.spec.tsx: model derivation + null arms, both kinds, the chat
// row's collapsed-by-default ToolRow card, and the keyed
