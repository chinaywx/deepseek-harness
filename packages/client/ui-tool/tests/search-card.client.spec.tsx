...
// over resultView, and the chat tool rows that consume it (GenericToolCard's
// fallback body and SearchRow, both composing the shared ToolRow with the
// search card collapsed by default). The keyed registration under
