...
// over the settled result view, and the chat tool row that consumes it (the
// keyed ReadRow and the GenericToolCard fallback, each composing ToolRow with
// the read card as its collapsed-by-default expanded body). Also pins the
// keyed 'read' toolview registration.
